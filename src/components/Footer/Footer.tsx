		...
		<Container>
			<div className={styles.content}>
				...
				<div className={styles.socialBox}>
					<a className={styles.socialIcon} href="src/components/Footer/Footer#"><i className="icon-facebook"/></a>
					<a className={styles.socialIcon} href="src/components/Footer/Footer#"><i className="icon-twitter"/></a>
					<a className={styles.socialIcon} href="src/components/Footer/Footer#"><i className="icon-instagram"/></a>
				</div>
